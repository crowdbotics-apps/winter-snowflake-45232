"""
Django settings for winter_snowflake_45232 project.
...
ROOT_URLCONF = 'winter_snowflake_45232.urls'
...
WSGI_APPLICATION = 'winter_snowflake_45232.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "winter_snowflake_45232 API",
    "DESCRIPTION": "API documentation for winter_snowflake_45232 App",
    "VERSION": "v1",
}
